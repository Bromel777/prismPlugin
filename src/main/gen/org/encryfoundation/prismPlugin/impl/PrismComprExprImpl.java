...
public class PrismComprExprImpl extends ASTWrapperPsiElement implements PrismComprExpr {

  public PrismComprExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PrismVisitor visitor) {
    visitor.visitComprExpr(this);
  }
