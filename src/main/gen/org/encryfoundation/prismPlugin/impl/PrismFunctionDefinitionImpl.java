...
public class PrismFunctionDefinitionImpl extends ASTWrapperPsiElement implements PrismFunctionDefinition {

  public PrismFunctionDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
