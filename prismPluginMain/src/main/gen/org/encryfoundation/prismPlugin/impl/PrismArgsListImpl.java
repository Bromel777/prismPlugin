...
public class PrismArgsListImpl extends ASTWrapperPsiElement implements PrismArgsList {

  public PrismArgsListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PrismVisitor visitor) {
    visitor.visitArgsList(this);
  }
